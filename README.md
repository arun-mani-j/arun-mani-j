...
I work on mobile Linux, especially [Phosh](https://phosh.mobi),
peer-to-peer software built on [Holepunch](https://github.com/holepunchto) technologies and AI
runtime engines based on [MLC LLM](https://llm.mlc.ai) and [TVM](https://tvm.apache.org).
My works are scattered across [Debian Salsa](https://salsa.debian.org/arun-mani-j), [Freedesktop GitLab](https://gitlab.freedesktop.org/arun-mani-j)
